...
if [ $? -eq 0 ]; then
    ...
    echo "   4. Update the tonconnect-manifest.json file with your app's domain"
    echo "   5. Make sure the TON_ADDRESS environment variable is set to your wallet address"
    echo "   6. Test the wallet connection by clicking the 'Connect Wallet' button in the app"
    echo ""
    ...
    echo "   5. Test TON wallet connection and payments"
    echo "   6. Verify that wallet addresses are stored correctly in the database"
else
