...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    // Refresh background particles periodically
    const particleInterval = setInterval(() => {
      createBackgroundParticles();
    }, 15000);
    
    // Add energy calculation interval
    const energyInterval = setInterval(calculateEnergy, 1000);
  ...
  return (
    <Layout>
      {showBuffer ? (
        <BufferScreen onLoadingComplete={() => setShowBuffer(false)} />
      ) : (
        <>
