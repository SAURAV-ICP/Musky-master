...
const INITIAL_ENERGY = 100; // 100 represents 100% energy
const ENERGY_DECREASE_PER_TAP = 0.1; // 0.1% of 100 (0.1 unit per tap)
...
export async function POST(request: Request): Promise<NextResponse<TapResponse>> {
  try {
    ...
    // Calculate new energy (decrease by 0.1% of 100, i.e., 0.1)
